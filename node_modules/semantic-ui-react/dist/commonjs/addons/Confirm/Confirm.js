...
function (_Component) {
  function Confirm() {
    ...
    return (0, _possibleConstructorReturn2.default)(_this, (_temp = _this = (0, _possibleConstructorReturn2.default)(this, (_getPrototypeOf2 = (0, _getPrototypeOf3.default)(Confirm)).call.apply(_getPrototypeOf2, [this].concat(args))), (0, _defineProperty2.default)((0, _defineProperty2.default)((0, _defineProperty2.default)((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)), "handleCancel", function (e) {
  ...
  (0, _createClass2.default)(Confirm, [{
    ...
    value: function render() {
      ...
      }), _Modal.default.Header.create(header), _Modal.default.Content.create(content), _react.default.createElement(_Modal.default.Actions, null, _Button.default.create(cancelButton, {
...
(0, _defineProperty2.default)((0, _defineProperty2.default)((0, _defineProperty2.default)(Confirm, "defaultProps", {
  cancelButton: 'Cancel',
  confirmButton: 'OK',
