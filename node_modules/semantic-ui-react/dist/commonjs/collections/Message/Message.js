...
function (_Component) {
  ...
  (0, _createClass2.default)(Message, [{
    ...
    value: function render() {
      ...
      return _react.default.createElement(ElementType, (0, _extends2.default)({}, rest, {
        className: classes
      }), dismissIcon, _Icon.default.create(icon), (!(0, _isNil2.default)(header) || !(0, _isNil2.default)(content) || !(0, _isNil2.default)(list)) && _react.default.createElement(_MessageContent.default, null, _MessageHeader.default.create(header), _MessageList.default.create(list), (0, _lib.createHTMLParagraph)(content)));
    }
  }]);
...
(0, _defineProperty2.default)((0, _defineProperty2.default)((0, _defineProperty2.default)((0, _defineProperty2.default)((0, _defineProperty2.default)((0, _defineProperty2.default)(Message, "_meta", {
  name: 'Message',
  type: _lib.META.TYPES.COLLECTION
}), "Content", _MessageContent.default), "Header", _MessageHeader.default), "List", _MessageList.default), "Item", _MessageItem.default), "handledProps", ["as", "attached", "children", "className", "color", "compact", "content", "error", "floating", "header", "hidden", "icon", "info", "list", "negative", "onDismiss", "positive", "size", "success", "visible", "warning"]);
