...
function (_Component) {
  function Popup() {
    ...
    return (0, _possibleConstructorReturn2.default)(_this, (_temp = _this = (0, _possibleConstructorReturn2.default)(this, (_getPrototypeOf2 = (0, _getPrototypeOf3.default)(Popup)).call.apply(_getPrototypeOf2, [this].concat(args))), (0, _defineProperty2.default)((0, _defineProperty2.default)((0, _defineProperty2.default)((0, _defineProperty2.default)((0, _defineProperty2.default)((0, _defineProperty2.default)((0, _defineProperty2.default)((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)), "state", {}), "hideOnScroll", function (e) {
      _this.setState({
        closed: true
      });
    ...
    }), "handlePopupRef", function (popupRef) {
  ...
  (0, _createClass2.default)(Popup, [{
    ...
    value: function render() {
      ...
      }), children, _lib.childrenUtils.isNil(children) && _PopupHeader.default.create(header), _lib.childrenUtils.isNil(children) && _PopupContent.default.create(content));
...
(0, _defineProperty2.default)((0, _defineProperty2.default)((0, _defineProperty2.default)((0, _defineProperty2.default)((0, _defineProperty2.default)(Popup, "defaultProps", {
  position: 'top left',
  on: 'hover',
  keepInViewPort: true
}), "_meta", {
...
}), "Content", _PopupContent.default), "Header", _PopupHeader.default), "handledProps", ["as", "basic", "children", "className", "content", "flowing", "header", "hideOnScroll", "horizontalOffset", "hoverable", "inverted", "keepInViewPort", "on", "onClose", "onMount", "onOpen", "onUnmount", "position", "size", "style", "trigger", "verticalOffset", "wide"]);
