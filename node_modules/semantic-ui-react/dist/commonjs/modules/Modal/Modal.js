...
function (_Component) {
  function Modal() {
    ...
    return (0, _possibleConstructorReturn2.default)(_this, (_temp = _this = (0, _possibleConstructorReturn2.default)(this, (_getPrototypeOf2 = (0, _getPrototypeOf3.default)(Modal)).call.apply(_getPrototypeOf2, [this].concat(args))), (0, _defineProperty2.default)((0, _defineProperty2.default)((0, _defineProperty2.default)((0, _defineProperty2.default)((0, _defineProperty2.default)((0, _defineProperty2.default)((0, _defineProperty2.default)((0, _defineProperty2.default)((0, _defineProperty2.default)((0, _defineProperty2.default)((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)), "getMountNode", function () {
      return (0, _lib.isBrowser)() ? _this.props.mountNode || document.body : null;
    }), "handleActionsOverrides", function (predefinedProps) {
      return {
      ...
      return _react.default.createElement(_Ref.default, {
        ...
        className: mountClasses,
        node: mountNode
      }), closeIconJSX, _ModalHeader.default.create(header), _ModalContent.default.create(content), _ModalActions.default.create(actions, {
  ...
  (0, _createClass2.default)(Modal, [{
    ...
    value: function render() {
      ...
      var dimmerClasses = !dimmer ? null : (0, _classnames.default)('ui', dimmer === 'inverted' && 'inverted', 'page modals dimmer transition visible active'); // Heads up!
      //
...
(0, _defineProperty2.default)((0, _defineProperty2.default)((0, _defineProperty2.default)((0, _defineProperty2.default)((0, _defineProperty2.default)((0, _defineProperty2.default)((0, _defineProperty2.default)((0, _defineProperty2.default)(Modal, "defaultProps", {
  dimmer: true,
  closeOnDimmerClick: true,
  closeOnDocumentClick: false,
  eventPool: 'Modal'
}), "autoControlledProps", ['open']), "_meta", {
  name: 'Modal',
  type: _lib.META.TYPES.MODULE
}), "Header", _ModalHeader.default), "Content", _ModalContent.default), "Description", _ModalDescription.default), "Actions", _ModalActions.default), "handledProps", ["actions", "as", "basic", "children", "className", "closeIcon", "closeOnDimmerClick", "closeOnDocumentClick", "content", "defaultOpen", "dimmer", "eventPool", "header", "mountNode", "onActionClick", "onClose", "onMount", "onOpen", "onUnmount", "open", "size", "style", "trigger"]);
Modal.propTypes = process.env.NODE_ENV !== "production" ? {
  ...
  dimmer: _propTypes.default.oneOfType([_propTypes.default.bool, _propTypes.default.oneOf(['inverted', 'blurring'])]),
