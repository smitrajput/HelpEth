...
function (_Component) {
  ...
  (0, _createClass2.default)(Embed, [{
    ...
    value: function render() {
      ...
      }), _Icon.default.create(icon), placeholder && _react.default.createElement("img", {
...
(0, _defineProperty2.default)((0, _defineProperty2.default)((0, _defineProperty2.default)((0, _defineProperty2.default)(Embed, "autoControlledProps", ['active']), "defaultProps", {
  icon: 'video play'
}), "_meta", {
  name: 'Embed',
  type: _lib.META.TYPES.MODULE
}), "handledProps", ["active", "as", "aspectRatio", "autoplay", "brandedUI", "children", "className", "color", "content", "defaultActive", "hd", "icon", "id", "iframe", "onClick", "placeholder", "source", "url"]);
