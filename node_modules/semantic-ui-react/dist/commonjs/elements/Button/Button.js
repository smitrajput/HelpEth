...
function (_Component) {
  function Button() {
    ...
    return (0, _possibleConstructorReturn2.default)(_this, (_temp = _this = (0, _possibleConstructorReturn2.default)(this, (_getPrototypeOf2 = (0, _getPrototypeOf3.default)(Button)).call.apply(_getPrototypeOf2, [this].concat(args))), (0, _defineProperty2.default)((0, _defineProperty2.default)((0, _defineProperty2.default)((0, _defineProperty2.default)((0, _defineProperty2.default)((0, _defineProperty2.default)((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)), "computeElementType", function () {
      var _this$props = _this.props,
          attached = _this$props.attached,
          label = _this$props.label;
      if (!(0, _isNil2.default)(attached) || !(0, _isNil2.default)(label)) return 'div';
    }), "computeTabIndex", function (ElementType) {
    ...
    value: function render() {
      ...
      if (!(0, _isNil2.default)(label)) {
        ...
        return _react.default.createElement(ElementType, (0, _extends2.default)({}, rest, {
          ...
          ref: this.handleRef,
          tabIndex: tabIndex
        }, _Icon.default.create(icon), " ", content), (labelPosition === 'right' || !labelPosition) && labelElement);
      }
      ...
      return _react.default.createElement(ElementType, (0, _extends2.default)({}, rest, {
        ...
        role: role,
        tabIndex: tabIndex
      }), hasChildren && children, !hasChildren && _Icon.default.create(icon), !hasChildren && content);
    }
  }]);
...
(0, _defineProperty2.default)((0, _defineProperty2.default)((0, _defineProperty2.default)((0, _defineProperty2.default)((0, _defineProperty2.default)((0, _defineProperty2.default)(Button, "defaultProps", {
  as: 'button',
  role: 'button'
}), "_meta", {
  name: 'Button',
  type: _lib.META.TYPES.ELEMENT
}), "Content", _ButtonContent.default), "Group", _ButtonGroup.default), "Or", _ButtonOr.default), "handledProps", ["active", "animated", "as", "attached", "basic", "children", "circular", "className", "color", "compact", "content", "disabled", "floated", "fluid", "icon", "inverted", "label", "labelPosition", "loading", "negative", "onClick", "positive", "primary", "role", "secondary", "size", "tabIndex", "toggle"]);
