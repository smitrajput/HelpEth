...
function (_Component) {
  function Label() {
    ...
    return (0, _possibleConstructorReturn2.default)(_this, (_temp = _this = (0, _possibleConstructorReturn2.default)(this, (_getPrototypeOf2 = (0, _getPrototypeOf3.default)(Label)).call.apply(_getPrototypeOf2, [this].concat(args))), (0, _defineProperty2.default)((0, _defineProperty2.default)((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)), "handleClick", function (e) {
  ...
  (0, _createClass2.default)(Label, [{
    ...
    value: function render() {
      ...
      return _react.default.createElement(ElementType, (0, _extends2.default)({
        className: classes,
        onClick: this.handleClick
      }, rest), _Icon.default.create(icon), typeof image !== 'boolean' && _Image.default.create(image), content, (0, _lib.createShorthand)(_LabelDetail.default, function (val) {
        return {
          content: val
        };
      }, detail), onRemove && _Icon.default.create(removeIconShorthand, {
...
(0, _defineProperty2.default)((0, _defineProperty2.default)((0, _defineProperty2.default)((0, _defineProperty2.default)(Label, "_meta", {
  name: 'Label',
  type: _lib.META.TYPES.ELEMENT
}), "Detail", _LabelDetail.default), "Group", _LabelGroup.default), "handledProps", ["active", "as", "attached", "basic", "children", "circular", "className", "color", "content", "corner", "detail", "empty", "floating", "horizontal", "icon", "image", "onClick", "onRemove", "pointing", "removeIcon", "ribbon", "size", "tag"]);
