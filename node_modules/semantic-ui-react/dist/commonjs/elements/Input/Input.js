...
function (_Component) {
  function Input() {
    ...
    return (0, _possibleConstructorReturn2.default)(_this, (_temp = _this = (0, _possibleConstructorReturn2.default)(this, (_getPrototypeOf2 = (0, _getPrototypeOf3.default)(Input)).call.apply(_getPrototypeOf2, [this].concat(args))), (0, _defineProperty2.default)((0, _defineProperty2.default)((0, _defineProperty2.default)((0, _defineProperty2.default)((0, _defineProperty2.default)((0, _defineProperty2.default)((0, _defineProperty2.default)((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)), "computeIcon", function () {
    ...
    }), "handleChildOverrides", function (child, defaultProps) {
    ...
    }), "handleInputRef", function (c) {
      return _this.inputRef = c;
    }), "partitionProps", function () {
  ...
  (0, _createClass2.default)(Input, [{
    ...
    value: function render() {
      ...
      }), actionPosition !== 'left' && actionElement, _Icon.default.create(this.computeIcon()), labelPosition === 'right' && labelElement);
    }
  }]);
...
(0, _defineProperty2.default)((0, _defineProperty2.default)((0, _defineProperty2.default)(Input, "defaultProps", {
  type: 'text'
}), "_meta", {
  name: 'Input',
  type: _lib.META.TYPES.ELEMENT
}), "handledProps", ["action", "actionPosition", "as", "children", "className", "disabled", "error", "fluid", "focus", "icon", "iconPosition", "input", "inverted", "label", "labelPosition", "loading", "onChange", "size", "tabIndex", "transparent", "type"]);
