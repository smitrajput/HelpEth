  ...
  (0, _createClass2.default)(ListItem, [{
    ...
    value: function render() {
      ...
      if (!_lib.childrenUtils.isNil(children)) {
        return _react.default.createElement(ElementType, (0, _extends2.default)({}, rest, valueProp, {
          role: "listitem",
          className: classes,
      ...
      var imageElement = _Image.default.create(image); // See description of `content` prop for explanation about why this is necessary.
      ...
      if (iconElement || imageElement) {
        return _react.default.createElement(ElementType, (0, _extends2.default)({}, rest, valueProp, {
          ...
          className: classes,
          onClick: this.handleClick
        }), iconElement || imageElement, (content || headerElement || descriptionElement) && _react.default.createElement(_ListContent.default, null, headerElement, descriptionElement, content));
      }
...
(0, _defineProperty2.default)((0, _defineProperty2.default)(ListItem, "_meta", {
  name: 'ListItem',
  parent: 'List',
  type: _lib.META.TYPES.ELEMENT
}), "handledProps", ["active", "as", "children", "className", "content", "description", "disabled", "header", "icon", "image", "onClick", "value"]);
